...
Para que un clon limpio del repositorio pueda reproducir el pipeline sin que falten ficheros, esta versión incluye los datos crudos usados por el proyecto dentro de `data/raw/`.
